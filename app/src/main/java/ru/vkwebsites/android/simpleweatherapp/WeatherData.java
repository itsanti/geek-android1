...
public class WeatherData {
    ...
    public String getWeatherByCity(String city, ArrayList<String> options) {
        String info = "";
        ...
        if (options.indexOf(MainActivity.swWeatherText) > -1) {
            info += ", " + data.get(city)[1];
        }

        if (options.indexOf(MainActivity.swHumidity) > -1) {
            info += ", " + data.get(city)[2];
        }
